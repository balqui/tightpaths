...
Copied from yacaree in early Floreal, then simplified as it is to
be used only to make up a few not too big graphs.
...
class ClMiner(dict):
    ...
    def test_size(self):
        return 0 # Nothing changes today
        # ~ """
...
if __name__ == "__main__":
    ...
    # ~ fnm = "../data/e13a"
    # ~ fnm = "../data/e13b"
    # ~ fnm = "../data/adultrain" # 33357 closures of support 137 or more, 269 items
    # ~ fnm = "../data/cmc-full" # 23016 closures of support 5 or more, 74 items
    # The next work thanks to the limit on the total support set lengths / NOT IMPLEMENTED ANYMORE
    # ~ fnm = "../data/chess.td"   # Fills memory with small heap size # 14191 cl of supp 2351 or more, 75 items
    # ~ fnm = "../data/connect.td" # Fills memory with ridiculous heap
                                   # size and less than 5000 closures # 1030 cl of supp 63812 or more, 129 items
    # ~ fnm = "../data/mushroomTr" # 23205 cl of supp 234 or more, 119 items
    # ~ fnm = "../data/votesTr" # 11858 cl of supp 83 or more, 50 items
    # ~ fnm = "../data/papersTr" # FILLS 15GB MEMORY ANYHOW EVEN WITH THE TOTAL SUPPORT SET LENGTHS LIMIT
                                 # 3251 cl of supp 22 or more, 8233 items
                                 
                                 # NOW: 1000 cl of supp 7 or more, 3873 items
                                 # supermarket: 11901 cl of supp 415 or more, 122 items
